...
rm TG_List.csv
wget https://raw.githubusercontent.com/HP1PAR/emq-TE1ws/main/TG_List.csv
...
#!/bin/bash
while : ; do
choix=$(whiptail --title "Rocket Project HP1PAR Pablo Rocchetta 73." --menu "Suba o Baje con las flechas del teclado y seleccione el numero de opcion" 20 50 11 \
...
choix=$(whiptail --title "TE1ws-Rev9 Rocket Project HP1PAR Pablo Rocchetta 73." --menu "Suba o Baje con las flechas del teclado y seleccione el numero de opcion:" 22 55 13 \
...
#!/bin/bash
while : ; do
choix=$(whiptail --title "Rocket Project HP1PAR Pablo Rocchetta 73." --menu "Suba o Baje con las flechas del teclado y seleccione el numero de opcion" 11 100 3 \
...
cat > /etc/pymultimonaprs.json  <<- "EOF"
{
        ...
        "beacon": {
                ...
                "table": "/",
                "symbol": "r",
                "comment": "APRS RX-IGATE / Rocket Project by HP1PAR",
                "status": {
                        "text": "",
                        "file": false
                },
...
cd /tmp/
wget https://github.com/HP1PAR/emq-TE1ws/raw/main/direwolf
...
CHANNEL 0
MYCALL HP1PAR-10
PBEACON sendto=IG delay=0:40 every=30 symbol="/r" lat=08^31.27N long=080^21.59W comment="APRS RX-IGATE / Rocket Project by HP1PAR"
...
#############################################################
#GPSD
#TBEACON every=0:30 symbol="/v" comment="APRS TRACKER / Rocket Project by HP1PAR" via=WIDE1-1,WIDE2-1
#PBEACON delay=0:05 every=30 symbol="/r" lat=08^31.27N long=080^21.59W comment="APRS DIGI-IGATE / Rocket Project by HP1PAR" via=WIDE2-2
#PBEACON sendto=IG delay=0:40 every=30 symbol="/r" lat=08^31.27N long=080^21.59W comment="APRS DIGI-IGATE / Rocket Project by HP1PAR"
#############################################################
#                                                           #
...
#!/bin/bash
while : ; do
choix=$(whiptail --title "Rocket Project HP1PAR Pablo Rocchetta 73." --menu "   Presione enter (return o intro) para finalizar la instalacion y reiniciar su equipo " 11 100 3 \
